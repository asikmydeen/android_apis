...
android {
    namespace = "dev.asik.devicebridge"
    compileSdk = 35

    defaultConfig {
        applicationId = "dev.asik.devicebridge"
        minSdk = 26
        targetSdk = 35
        versionCode = 4
        versionName = "1.3.1"
    ...
    signingConfigs {
        create("release") {
            ...
            val storeFilePath = System.getenv("STORE_FILE") ?: keystoreProperties.getProperty("storeFile")
...
dependencies {
    ...
    // Optional SLF4J no-op to satisfy Ktor logging bridges
